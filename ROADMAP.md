...
This document outlines planned improvements for this project.
...
Open a GitHub Issue with the label `enhancement`. Describe the use case, not just the feature, so we can find the best solution.
