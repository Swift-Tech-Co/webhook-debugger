...
- Python: PEP 8, type hints on public functions, brief docstrings on modules and classes
...
- Solidity: NatSpec comments, reentrancy guards, Checks-Effects-Interactions pattern
- Shell / Bash: `set -euo pipefail`, quote variables, avoid unnecessary subshells

No em dashes or en dashes in user-visible text. Use "to" for ranges and colons instead of dashes in flowing copy.
...
Do not open a public issue for security vulnerabilities. Email **swifttechcocanada@gmail.com** directly with a description of the vulnerability, steps to reproduce, and potential impact. We will respond within 48 hours.
